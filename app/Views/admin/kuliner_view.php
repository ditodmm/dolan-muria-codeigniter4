        ...
        <table class='table table-striped' id="table1">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= number_format($row->harga_kuliner,0,",","."); ?></td>
                    <td>
...
<!-- Modal Edit Product-->
<form action="<?= base_url(); ?>/adminkuliner/update" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="harga_kuliner" id="harga_kuliner" placeholder="Harga kuliner"  oninvalid="this.setCustomValidity('Wajib diisi!')" oninput="this.setCustomValidity('')" onkeypress="return hanyaAngka(event)">
                    </div>  
...
<form action="<?= base_url(); ?>/adminkuliner/updategambarsampul" method="post" enctype="multipart/form-data">
...
<form action="<?= base_url(); ?>/adminkuliner/updategambar1" method="post" enctype="multipart/form-data">
...
<form action="<?= base_url(); ?>/adminkuliner/updategambar2" method="post" enctype="multipart/form-data">
...
<!-- Modal Edit Gambar 3-->
<form action="<?= base_url(); ?>/adminkuliner/updategambar3" method="post" enctype="multipart/form-data">
...
<form action="<?= base_url(); ?>/adminkuliner/delete" method="post">
