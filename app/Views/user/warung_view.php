...
<head>
    ...
    <title>Dolan Muria - Kuliner</title>
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="bradcam_text text-center">
                            ...
                            <p>Ayo kunjungi tempat kuliner khas Muria.</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="item col-lg-4 col-md-4 all">
                                <div class="single_place">
                                    ...
                                    <div class="place_info">
                                        <a href="<?= base_url() . '/userkuliner/listkuliner/' . $row->id_user_pemilik_toko; ?>"><h3><?= $row->nama_toko ?></h3></a>
                                        <p><?= $row->no_telepon; ?></p>
