...
<head>
    ...
    <title>Dolan Muria - Wisata</title>
...
<body>
    <!--[if lte IE 9]>
        ...
        <!-- bradcam_area style="background-image: url(<?= base_url(); ?>/user/img/banner/wisatabanner.png"  -->
                ...
                <div class="filters">
                    <ul>
                        ...
                        <?php foreach($tb_kategori as $row): ?>
                            <li class="list" data-filter="<?= $row->id_kategori; ?>"><?= $row->nama_kategori; ?></li>
                        <?php endforeach; ?>
                    </ul>
                </div>
                ...
                <div class="filters-content col-lg-12">
                    <div class="row">
                    	<?php foreach($tb_wisata as $row): ?>
                            <div class="item col-lg-4 col-md-4 all <?= $row->kategori_wisata ?>">
