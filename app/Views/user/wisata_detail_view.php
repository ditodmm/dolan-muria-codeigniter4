...
<head>
  ...
  <title>Dolan Muria - <?= $tb_wisata->nama_wisata; ?></title>
...
<body>
    <!--[if lte IE 9]>
          ...
          <!-- header-end -->
          <div  style="background-image: url(<?= base_url(); ?>/uploads/gambarwisata/<?= $tb_wisata->gambar_wisata; ?>);" class="destination_banner_wrap overlay">
            <div class="destination_text text-center">
              <h3><?= $tb_wisata->nama_wisata; ?></h3>
            </div>
          </div>
                    ...
                    <div class="single_destination">
                      <div class="row">
                        <div class="col-6">
                          ...
                          <p><i class="fa fa-bookmark-o"></i>&ensp;Wisata <?= $tb_wisata->nama_kategori;?></p>
                        </div>
                        <div class="col-6">
                          <h3>Harga Tiket Masuk Wisata</h3>
                          <p><i class="fa fa-ticket"></i>&ensp;Rp <?= $tb_wisata->tiket_wisata; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="single_destination">
                      <h3>Deskripsi Wisata</h3>
                      <p>&emsp;&emsp;<?= $tb_wisata->deskripsi_wisata; ?></p>
                    </div>
                    <div class="single_destination">
                      <div class="row">
                        <div class="col-6">
                          <h3>Hari dan Jam Buka</h3>
                          <p><i class="fa fa-calendar-o"></i>&ensp;<?= $tb_wisata->hari_buka_dari." - ".$tb_wisata->hari_buka_sampai ?></p>
                          <p><i class="fa fa-clock-o"></i>&ensp;<?= substr($tb_wisata->jam_buka_dari,0,5)." - ".substr($tb_wisata->jam_buka_sampai,0,5) ?></p>
                        </div>
                        <div class="col-6">
                          <h3>Alamat Wisata</h3>
                          <p><i class="fa fa-map-marker"></i>&ensp;<?= $tb_wisata->alamat_wisata; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="single_destination">
                      <h3>Google Maps</h3>
                      <iframe <?= htmlspecialchars_decode($tb_wisata->gmaps_wisata); ?> width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                    <div class="single_destination">
                      <h3>Gambar Lainnya</h3>
                      <div class="row">
                        <?php foreach ($tb_gambar_wisata as $row): ?>
                          <div style="margin-top: 25px;" class="col-md-6">
                            <a class="btn-tampil-gambar" data-gambar="<?= $row->nama_gambar_wisata;?>" data-deskripsi="<?= $row->deskripsi_gambar_wisata;?>" data-sumber="<?= $row->sumber_gambar_wisata;?>">
                              <img style="cursor: zoom-in; transition: 0.3s;" width="100%" class="img-thumbnail" src="<?= base_url() . "/uploads/gambarwisata/" . $row->nama_gambar_wisata; ?>" alt="<?= $row->deskripsi_gambar_wisata; ?>">
                            </a>
                          </div>
                        <?php endforeach; ?>
                      </div>
        ...
        <div class="popular_places_area">
          <div class="container">
            ...
            <div class="row">
              <?php foreach ($tb_wisata_rekomendasi as $row): ?>
                <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                    <div class="thumb">
                      <a href="<?= base_url() . '/userwisata/detail/' . $row->id_wisata; ?>">
                        <img src="<?= base_url() . "/uploads/gambarwisata/" . $row->gambar_wisata; ?>" alt="">
                      </a>
                    </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="form-group">
                  ...
                  <p style="text-align: center;">Sumber Gambar : <span id="sumber"></span></p>
                </div>                      
              </div>
            </div>
          </div>
...
<!--     
    ...
    <script>
      ...
      $('body').on('click','.btn-tampil-gambar',function(){
        ...
        $('.modal-body #sumber').html(sumber);
        $('.modal-body #tampil_gambar').attr('src','<?= base_url(); ?>/uploads/gambarwisata/'+gambar);
        // Call Modal Edit
