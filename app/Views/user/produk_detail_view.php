...
<head>
  ...
  <title>Dolan Muria - <?= $tb_produk->nama_produk; ?></title>
...
<body>
    <!--[if lte IE 9]>
          ...
          <!-- header-end -->
          <div  style="background-image: url(<?= base_url(); ?>/uploads/gambarproduk/<?= $tb_produk->gambar_sampul_produk; ?>);" class="destination_banner_wrap overlay">
            <div class="destination_text text-center">
              <h3><?= $tb_produk->nama_produk; ?></h3>
              <br>
              <p>Rp. <?= number_format($tb_produk->harga_produk,2,",","."); ?></p>
              <p>Toko <?= $tb_produk->nama_toko; ?></p>
            </div>
          </div>
                ...
                <div class="col-lg-8 col-md-9">
                  <div class="destination_info">
                    <div class="single_destination">
                      ...
                      <p>&emsp;<?= $tb_produk->deskripsi_produk; ?></p>
                      <img style="display:block; margin-left: auto; margin-right: auto; width: 60%;" class="rounded" src="<?= base_url() . "/uploads/gambarproduk/" . $tb_produk->gambar_produk_1; ?>" alt="Gambar produk">
                    </div>
                    <div class="single_destination">
                      <div class="row">
                        <div class="col-6">
                          <h3>Hari dan Jam Buka</h3>
                          <p><i class="fa fa-calendar-o"></i>&ensp;<?= $tb_produk->hari_buka_dari." - ".$tb_produk->hari_buka_sampai ?></p>
                          <p><i class="fa fa-clock-o"></i>&ensp;<?= substr($tb_produk->jam_buka_dari,0,5)." - ".substr($tb_produk->jam_buka_sampai,0,5) ?></p>
                        </div>
                        <div class="col-6">
                          <h3>Alamat Toko</h3>
                          <p><i class="fa fa-map-marker"></i>&ensp;<?= $tb_produk->alamat_toko; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="single_destination">
                      <div class="row">
                        <div class="col-6">
                          <h3>Email</h3>
                          <p><i class="fa fa-envelope-o"></i>&ensp;<?= $tb_produk->email_toko; ?></p>
                        </div>
                        <div class="col-6">
                          <h3>Nomor Telepon</h3>
                          <p><i class="fa fa-phone"></i>&ensp;<?= $tb_produk->no_telepon; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="single_destination">
                      <h3>Google Maps</h3>
                      <iframe <?= htmlspecialchars_decode($tb_produk->gmaps_toko); ?> width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                    <div class="single_destination">
                      <h3>Gambar Lainnya</h3>
                      <div class="row">
                        <div style="margin-top: 25px;" class="col-md-6">
                          <a class="btn-tampil-gambar" data-gambar="<?= $tb_produk->gambar_produk_2;?>" data-deskripsi="Gambar produk">
                            <img style="cursor: pointer; transition: 0.3s;" width="100%" class="img-thumbnail" src="<?= base_url() . "/uploads/gambarproduk/" . $tb_produk->gambar_produk_2; ?>" alt="Gambar produk">
                          </a>
                        </div>
                        <div style="margin-top: 25px;" class="col-md-6">
                          <a class="btn-tampil-gambar" data-gambar="<?= $tb_produk->gambar_produk_3;?>" data-deskripsi="Gambar Produk">
                            <img style="cursor: pointer; transition: 0.3s;" width="100%" class="img-thumbnail" src="<?= base_url() . "/uploads/gambarproduk/" . $tb_produk->gambar_produk_3; ?>" alt="Gambar produk">
                          </a>
                        </div>
                      </div>
                    </div>
        ...
        <div class="popular_places_area">
          <div class="container">
            ...
            <div class="row">
              <?php foreach ($tb_produk_rekomendasi as $row): ?>
                <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                    <div class="thumb">
                      <a href="<?= base_url() . '/userproduk/detail/' . $row->id_produk; ?>">
                        <img src="<?= base_url() . "/uploads/gambarproduk/" . $row->gambar_sampul_produk; ?>" alt="">
                      </a>
                    </div>
                    <div class="place_info">
                      <a href="#"><h3><?= $row->nama_produk; ?></h3></a>
                      <p><?= $row->nama_toko; ?></p>
...
<!--     
    ...
    <script>
      ...
      $('body').on('click','.btn-tampil-gambar',function(){
        ...
        $('.modal-body #tampil_gambar').attr('src','<?= base_url(); ?>/uploads/gambarproduk/'+gambar);
        // Call Modal Edit
