...
<head>
  ...
  <title>Dolan Muria - <?= $tb_penginapan->nama_penginapan; ?></title>
...
<body>
    <!--[if lte IE 9]>
          ...
          <!-- header-end -->
          <div  style="background-image: url(<?= base_url(); ?>/uploads/gambarpenginapan/<?= $tb_penginapan->gambar_sampul_penginapan; ?>);" class="destination_banner_wrap overlay">
            <div class="destination_text text-center">
              <h3><?= $tb_penginapan->nama_penginapan; ?></h3>
              <p><?= $tb_penginapan->alamat_penginapan; ?></p>
            </div>
          </div>
                ...
                <div class="col-lg-8 col-md-9">
                  <div class="destination_info">
                    <div class="single_destination">
                      <h3>Deskripsi penginapan</h3>
                      <p>&emsp;<?= $tb_penginapan->deskripsi_penginapan; ?></p>
                      <img style="display:block; margin-left: auto; margin-right: auto; width: 60%;" class="rounded" src="<?= base_url() . "/uploads/gambarpenginapan/" . $tb_penginapan->gambar_sampul_penginapan; ?>" alt="Gambar penginapan">
                    </div>
                    <div class="single_destination">
                      <div class="row">
                        <div class="col-6">
                          <h3>Alamat Penginapan</h3>
                          <p><i class="fa fa-map-marker"></i>&ensp;<?= $tb_penginapan->alamat_penginapan; ?></p>
                        </div>
                        <div class="col-6">
                          <h3>Nomor Telepon</h3>
                          <p><i class="fa fa-phone"></i>&ensp;<?= $tb_penginapan->no_telepon; ?></p>
                        </div>
                      </div>
                    </div>
                    <div class="single_destination">
                      <h3>Google Maps</h3>
                      <iframe <?= htmlspecialchars_decode($tb_penginapan->gmaps_penginapan); ?> width="100%" height="300" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
                    </div>
                    <div class="single_destination">
                      <h3>Gambar Lainnya</h3>
                      <div class="row">
                        <div style="margin-top: 25px;" class="col-md-6">
                          <a class="btn-tampil-gambar" data-gambar="<?= $tb_penginapan->gambar_penginapan_1;?>" data-deskripsi="Gambar penginapan">
                            <img style="cursor: pointer; transition: 0.3s;" width="100%" class="img-thumbnail" src="<?= base_url() . "/uploads/gambarpenginapan/" . $tb_penginapan->gambar_penginapan_1; ?>" alt="Gambar penginapan">
                          </a>
                        </div>
                        <div style="margin-top: 25px;" class="col-md-6">
                          <a class="btn-tampil-gambar" data-gambar="<?= $tb_penginapan->gambar_penginapan_1;?>" data-deskripsi="Gambar penginapan">
            ...
            <div class="row justify-content-center">
              <div class="col-lg-6">
                <div class="section_title text-center mb_70">
                  <h3>penginapan Lainnya</h3>
                </div>
              </div>
            </div>
            <div class="row">
              <?php foreach ($tb_penginapan_rekomendasi as $row): ?>
                <div class="col-lg-4 col-md-6">
                  <div class="single_place">
                    <div class="thumb">
                      <a href="<?= base_url() . '/userpenginapan/detail/' . $row->id_penginapan; ?>">
                        <img src="<?= base_url() . "/uploads/gambarpenginapan/" . $row->gambar_sampul_penginapan; ?>" alt="">
                      </a>
                    </div>
                    <div class="place_info">
                      <a href="#"><h3><?= $row->nama_penginapan; ?></h3></a>
...
<!--     
    ...
    <script>
      ...
      $('body').on('click','.btn-tampil-gambar',function(){
        ...
        $('.modal-body #tampil_gambar').attr('src','<?= base_url(); ?>/uploads/gambarpenginapan/'+gambar);
        // Call Modal Edit
