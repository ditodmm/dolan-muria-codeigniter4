...
<div class="main-content container-fluid">
    ...
    <section class="section">
        ...
        <?php endif; ?>
        <button type="button" class="btn btn-secondary mb-2 icon-left" data-bs-toggle="modal" data-bs-target="#addModal"><i data-feather="plus-circle"></i> Tambah Produk</button>
    </div>
    <div class="card-body">
...
<!-- Modal Add Product-->
<form action="<?= base_url(); ?>/pemilikproduk/save" method="post" enctype="multipart/form-data">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_produk" placeholder="Nama produk" required  oninvalid="this.setCustomValidity('Wajib diisi!')" oninput="this.setCustomValidity('')">
                    </div>
                    
                    <div class="form-group">
                        <label>Deskripsi produk</label>
                        <textarea class="form-control" name="deskripsi_produk" placeholder="Deskripsi produk" required  oninvalid="this.setCustomValidity('Wajib diisi!')" oninput="this.setCustomValidity('')"></textarea>
                    </div>

                    <div class="form-group">
                        <label>Harga produk</label>
                        <input type="text" class="form-control" name="harga_produk" placeholder="Harga produk" required oninvalid="this.setCustomValidity('Wajib diisi!')" oninput="this.setCustomValidity('')">
                    </div>

                    <div class="form-group">
                        <label>Gambar Sampul Produk</label>
                        <input type="file" class="form-control" name="gambar_sampul_produk">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="gambar_produk_1">
                        Format file: .jpg, .jpeg, .png<br>
                        Ukuran maksimal: 2 MB
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="gambar_produk_2">
                        Format file: .jpg, .jpeg, .png<br>
                        Ukuran maksimal: 2 MB
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" class="form-control" name="gambar_produk_3">
                        Format file: .jpg, .jpeg, .png<br>
                        Ukuran maksimal: 2 MB
                    </div>                 
...
<!-- Modal Edit Product-->
<form action="<?= base_url(); ?>/pemilikproduk/update" method="post" enctype="multipart/form-data">
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Tempat produk</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label>Harga produk</label>
                        <input type="text" class="form-control" name="harga_produk" id="harga_produk" placeholder="Harga produk"  oninvalid="this.setCustomValidity('Wajib diisi!')" oninput="this.setCustomValidity('')">
                    </div>  
...
<form action="<?= base_url(); ?>/pemilikproduk/updategambarsampul" method="post" enctype="multipart/form-data">
...
<form action="<?= base_url(); ?>/pemilikproduk/updategambar1" method="post" enctype="multipart/form-data">
...
<form action="<?= base_url(); ?>/pemilikproduk/updategambar2" method="post" enctype="multipart/form-data">
...
<!-- Modal Edit Gambar 3-->
<form action="<?= base_url(); ?>/pemilikproduk/updategambar3" method="post" enctype="multipart/form-data">
